...
<x-header>Post New Film</x-header>
...
<x-layout>
    ...
    @endif
    <div class="m-4">
        <form action="{{ route('admin.proses-post-film') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group"> <!--Gausah Di buka Ini Select untuk memilih negara-->
            ...
            <a href="{{ route('admin.table-film') }}" class="btn btn-danger">Cancel</a>
        </form>
    </div>
